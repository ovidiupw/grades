...
const ListProfessors = require('../../../app/route_handlers/professors/ListProfessors');
...
describe('List Students Test', function () {
  ...
  it('Should validate the request', function (done) {
    ListProfessors.validateRequest(req, function (errCallback) {
      if (errCallback) {
        done(errCallback);
      } else {
        done();
  ...
  it('Should find the user that wants to list the professors', function (done) {
    ListProfessors.findUser(req, function (errCallback) {
      if (errCallback) {
        done(errCallback);
      } else {
        done();
  ...
  it('Should validate the apikey', function (done) {
    ListProfessors.validateApiKey(req, user, function (errCallback) {
      if (errCallback) {
        done(errCallback);
      } else {
        done();
  ...
  it('Should validate the access rights', function (done) {
    ListProfessors.validateAccessRights( user, function (errCallback) {
      if (errCallback) {
        done(errCallback);
      } else {
        done();
  ...
  it('Should list the students', function (done) {
    ListProfessors.listProfessors( function (errCallback) {
      if (errCallback) {
        done(errCallback);
      } else {
        done();
