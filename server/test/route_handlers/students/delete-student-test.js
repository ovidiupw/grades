...
const DeleteStudent = require('../../../app/route_handlers/students/DeleteStudent');

Mongoose.connect(DB.TEST_DB);

describe('Delete Student Test', function () {
  ...
  it('Should validate the request', function (done) {
    DeleteStudent.validateRequest(req, function (errCallback) {
      if (errCallback) {
        done(errCallback);
      } else {
        done();
  ...
  it('Should find the user that wants to delete a student', function (done) {
    DeleteStudent.findUser(req, function (errCallback) {
      if (errCallback) {
        done(errCallback);
      } else {
        done();
  ...
  it('Should validate the apikey', function (done) {
    DeleteStudent.validateApiKey(req, user, function (errCallback) {
      if (errCallback) {
        done(errCallback);
      } else {
        done();
  ...
  it('Should validate the access rights', function (done) {
    DeleteStudent.validateAccessRights(req, user, function (errCallback) {
      if (errCallback) {
        done(errCallback);
      } else {
        done();
  ...
  it('Should delete the student', function (done) {
    DeleteStudent.deleteStudent(req, function (errCallback) {
      if (errCallback) {
        done(errCallback);
      } else {
        done();
